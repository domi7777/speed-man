function Stage1(stageContext){
    ...
    function createForeGround(){
        ...
        stageContext.addGameItem(wall3);
        ...
        stageContext.addGameItem(wall4);
        ...
        stageContext.addGameItem(bossGate);
...
//        stageContext.addGameItem(enemy1);
        ...
        stageContext.addGameItem(screenBorderTop);
        stageContext.addGameItem(screenBorderBottom);
        stageContext.addGameItem(screenBorderRight);
        stageContext.addGameItem(screenBorderLeft);
